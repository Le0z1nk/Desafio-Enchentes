    ...
    return (
        <BrowserRouter>
            <header>
                ...
                <nav>
                    <ul>
                        <li><svg className="searchIcon" width="15px" height="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <section className="sectionConta">
                    <div className="divBotoesConta">
                        <NavLink to="/login"><button className="botaoLogin"><svg class="loginIcon" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <NavLink to="/cadastro"><button className="botaoCadastrar">Cadastre-se</button></NavLink>
                    </div>
                </section>
            </header>
            <Routes>
